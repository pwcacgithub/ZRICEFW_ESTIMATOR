class ZCL_ZRICEFW_ESTIMATOR_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZRICEFW_ESTIMATOR_MPC=====CP' ##NO_TEXT.
...
CLASS ZCL_ZRICEFW_ESTIMATOR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZRICEFW_ESTIMATOR_SRV_01' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20190610113616'.                  "#EC NOTEXT
